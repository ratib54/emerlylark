    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
        <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
          <div
            className="transition-all duration-500 lg:group-hover:scale-105 lg:group-hover:opacity-20 tobii-zoom"
            title=""
          >
            <img src={img1} alt="" />
          </div>
          <h1 className="font-semibold text-xl my-1 text-center">
            Mobile Reselling Platform
          </h1>
          <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-evenly items-center">
            ...
            <Link to="/projects/1" className="custom-btn">
              View Details
            </Link>
            <a
              target="_blank"
        ...
        <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
          ...
          <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-around items-center">
            ...
            <Link to="/projects/3" className="custom-btn">
              View Details
            </Link>
            <a
              target="_blank"
        ...
        <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
          ...
          <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-around items-center">
            ...
            <Link to="/projects/2" className="custom-btn">
              View Details
            </Link>
            <a
              target="_blank"

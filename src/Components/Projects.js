            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
                    ...
                    <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-around items-center">
                        <a target='_blank' rel="noreferrer" href="https://mobile-resell-wizards.web.app/" className="custom-btn">Live Website</a>
                        <a target='_blank' rel="noreferrer" href="https://github.com/FarhanZizz/mobile-resell-wizards-client" className="custom-btn">View Code</a>
                    </div>
                </div>
                <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
                    <div className="transition-all duration-500 lg:group-hover:scale-105 lg:group-hover:opacity-20 tobii-zoom" title="">
                    ...
                    <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-around items-center">
                        <a target='_blank' rel="noreferrer" href="https://tech-ed-6d513.web.app/" className="custom-btn">Live Website</a>
                        <a target='_blank' rel="noreferrer" href="https://github.com/FarhanZizz/tech-ed" className="custom-btn">View Code</a>
                    </div>
                </div>
                <div className="group lg:relative block lg:overflow-hidden rounded-md transition-all duration-500">
                    <div className="transition-all duration-500 lg:group-hover:scale-105 lg:group-hover:opacity-20 tobii-zoom" title="">
                    ...
                    <div className="lg:absolute lg:group-hover:inset-0 right-2 left-2 p-4 rounded shadow flex justify-around items-center">
                        <a target='_blank' rel="noreferrer" href="https://lens-knight.web.app/" className="custom-btn">Live Website</a>
                        <a target='_blank' rel="noreferrer" href="https://github.com/FarhanZizz/lens-knight-client" className="custom-btn">View Code</a>
                    </div>
                </div>
            </div>
        </div>
